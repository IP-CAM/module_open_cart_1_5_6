...
class ControllerCheckoutPlatronSuccess extends Controller { 
	public function index() { 	
		...
		$this->language->load('checkout/platron_success');
		...
		$this->data['breadcrumbs'][] = array(
      	...
      	$this->data['breadcrumbs'][] = array(
        	'href'      => $this->url->link('checkout/platron_success'),
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/platron_success.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/common/platron_success.tpl';
		} else {
			$this->template = 'default/template/common/platron_success.tpl';
		}
