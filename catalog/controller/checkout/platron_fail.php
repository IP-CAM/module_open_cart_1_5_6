...
class ControllerCheckoutPlatronFail extends Controller { 
	public function index() { 	
		...
		$this->language->load('checkout/platron_fail');
		...
		$this->data['breadcrumbs'][] = array(
      	...
      	$this->data['breadcrumbs'][] = array(
        	'href'      => $this->url->link('checkout/platron_fail'),
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/platron_fail.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/common/platron_fail.tpl';
		} else {
			$this->template = 'default/template/common/platron_fail.tpl';
		}
